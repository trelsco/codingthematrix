...
indep_vec_1 = Vec({0,1,2,3}, {0:1,1:-1})
indep_vec_2 = Vec({0,1,2,3}, {1:1,2:-1})
indep_vec_3 = Vec({0,1,2,3}, {2:1,3:-1})
indep_vec_4 = Vec({0,1,2,3}, {3:1,0:-1})
